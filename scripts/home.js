...
function loadMotd() {
  ...
  const motdList = [
    ...
    "Why is Minecraft called Minecraft? Because mining is a *blocky* business.",
    ...
    "`git push --force`: Because sometimes you have commitment issues.",
    ...
    "In Java we trust — except when it throws `NullPointerException`.",
    ...
    "Welcome. Please don't touch anything. Especially *that*.",
    ...
    "∿ Waiting for meaning...",
    "This is an MOTD. It doesn't *have* to make sense.",
    ...
    "Just you, me, and this lonely little `<div>`.",
    ...
    "Error 200: Everything's fine. Probably.",
